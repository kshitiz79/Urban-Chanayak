...
const Testimonial = () => {
  return (
    <div className="flex flex-col items-center py-24 px-10 bg-white">
      <div className="border-4 border-black rounded-2xl p-8 text-center">
        ...
        <p className="text-orange-500 text-2xl font-semibold text-left mt-40">Welcome to Urban Chanakya </p>
      </div>
    </div>
  );
};
