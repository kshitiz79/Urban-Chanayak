  ...
  return (
    <div className="relative bg-white scroll-smooth">
      <div className="py-10 px-8 md:px-0 bg-white max-w-5xl mx-auto">
        ...
        <div className="text-black text-lg md:text-xl mt-12 md:ml-80 ml-4">
          <h2 className="text-xl md:text-2xl font-bold mb-4">Case Study 1: Himanta Biswa Sarma</h2>
          <h3 className="text-lg md:text-xl font-semibold mb-6 italic">The Storyteller of Governance</h3>
        ...
        <div className="text-black text-lg md:text-xl md:py-16 py-10 md:ml-80 ml-4">
          ...
          <p className="font-semibold mb-2">Key pillars of his strategy:</p>
