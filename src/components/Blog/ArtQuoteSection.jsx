      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 flex flex-col md:flex-row gap-6">
          <div className="w-full md:w-1/2">
            <img
              src="https://images.unsplash.com/photo-1501854140801-50d01698950b?fit=crop&w=400&h=300" // Placeholder for artwork
          ...
          <div className="w-full md:w-1/2">
            <img
              src="https://cdn.prod.website-files.com/66336211b81e8a10a1428f79/6659a211fb7fcee3d67868ce_PC%20Elliott%20Muscat-min.webp" // Provided artist photo
